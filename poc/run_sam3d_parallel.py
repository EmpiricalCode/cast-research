...
#
# Usage:
#   torchrun --nproc_per_node=NUM_GPUS poc/run_sam3d_parallel.py [--image ...] [--masks-dir ...] [--output-dir ...]
#
# For multiple processes on a single GPU (time-sliced):
#   torchrun --nproc_per_node=NUM_WORKERS poc/run_sam3d_parallel.py [args]
